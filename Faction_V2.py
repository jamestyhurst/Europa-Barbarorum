...
class Faction:
    ...
    def manage_province(self, turn, season, Player):
        ...
        while choice_loop == True:
            ...
            elif province_selection == '5' and ProvinceArray[4] in self.provinces:
                action_loop = True
                selected_province = ProvinceArray[4]
                print(f"The Province of {ProvinceArray[4]['name']}")
            elif province_selection == '6' and ProvinceArray[5] in self.provinces:
                action_loop = True
                selected_province = ProvinceArray[5]
                print(f"The Province of {ProvinceArray[5]['name']}")
            elif province_selection == '7' and ProvinceArray[6] in self.provinces:
                action_loop = True
                selected_province = ProvinceArray[6]
                print(f"The Province of {ProvinceArray[6]['name']}")
            elif province_selection == '8' and ProvinceArray[7] in self.provinces:
                action_loop = True
                selected_province = ProvinceArray[7]
                print(f"The Province of {ProvinceArray[7]['name']}")
            elif province_selection == 'x':
                print("Exiting Menu")
                action_loop = False
                choice_loop = False
