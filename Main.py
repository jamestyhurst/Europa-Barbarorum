...
while game_running:
    ...
    while campaign_loop == True:
        ...
        faction_choice = faction_choice.upper()
        if faction_choice.isdigit():
            print("faction_choice", faction_choice)
            if 1 <= int(faction_choice) <= len(faction_array):
        ...
        while session_running:
            ...
            print(
                f"You have {Player.treasury} denarii and {Player.population} population")
            ...
            if turn_choice == '1':
                print(
                    f" You have {Player.treasury} gold, {Player.population} population, and {Player.size} provinces")
